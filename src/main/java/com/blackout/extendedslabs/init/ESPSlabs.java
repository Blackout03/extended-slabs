...
public class ESPSlabs {
	...
	public static final RegistryObject<SlabBlock> COARSE_DIRT_SLAB = registerBlock("coarse_dirt_slab", () -> new SlabBlock(Block.Properties.copy(Blocks.COARSE_DIRT)), ExtendedSlabs.GROUP);
	public static final RegistryObject<SlabBlock> ROOTED_DIRT_SLAB = registerBlock("rooted_dirt_slab", () -> new SlabBlock(Block.Properties.copy(Blocks.ROOTED_DIRT)), ExtendedSlabs.GROUP);
	...
	// WOOD
	public static final RegistryObject<SlabBlock> OAK_WOOD_SLAB = registerBlock("oak_wood_slab", () -> new SlabBlock(Block.Properties.copy(Blocks.OAK_WOOD)), ExtendedSlabs.GROUP);
	public static final RegistryObject<SlabBlock> SPRUCE_WOOD_SLAB = registerBlock("spruce_wood_slab", () -> new SlabBlock(Block.Properties.copy(Blocks.SPRUCE_WOOD)), ExtendedSlabs.GROUP);
	public static final RegistryObject<SlabBlock> BIRCH_WOOD_SLAB = registerBlock("birch_wood_slab", () -> new SlabBlock(Block.Properties.copy(Blocks.BIRCH_WOOD)), ExtendedSlabs.GROUP);
	...
	// NETHER
	public static final RegistryObject<SlabBlock> NETHERRACK_SLAB = registerBlock("netherrack_slab",() -> new SlabBlock(Block.Properties.copy(Blocks.NETHERRACK).requiresCorrectToolForDrops()), ExtendedSlabs.GROUP);
