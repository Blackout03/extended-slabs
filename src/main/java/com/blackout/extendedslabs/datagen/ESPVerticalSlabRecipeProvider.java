...
public class ESPVerticalSlabRecipeProvider extends RecipeProvider {
    ...
    public void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.END_STONE), ESPVerticalSlabs.END_STONE_VERTICAL.get(), 2).unlockedBy("has_end_stone", has(Blocks.NETHERRACK)).save(consumer, "end_stone_vertical_slab_from_end_stone_stonecutting");
    }
