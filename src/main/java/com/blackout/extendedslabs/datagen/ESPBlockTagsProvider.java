...
public class ESPBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(ESPSlabs.END_STONE_SLAB.get(), ESPSlabs.NETHERRACK_SLAB.get(),
                ...
                BOPVerticalSlabs.BLACK_SANDSTONE_VERTICAL.get(), BOPVerticalSlabs.CUT_BLACK_SANDSTONE_VERTICAL.get(),
                BOPVerticalSlabs.SMOOTH_BLACK_SANDSTONE_VERTICAL.get(), BOPVerticalSlabs.ORANGE_SANDSTONE_VERTICAL.get(),
                BOPVerticalSlabs.CUT_ORANGE_SANDSTONE_VERTICAL.get(), BOPVerticalSlabs.SMOOTH_ORANGE_SANDSTONE_VERTICAL.get(),
                BOPVerticalSlabs.WHITE_SANDSTONE_VERTICAL.get(), BOPVerticalSlabs.CUT_WHITE_SANDSTONE_VERTICAL.get(),
                BOPVerticalSlabs.SMOOTH_WHITE_SANDSTONE_VERTICAL.get(), ESPVerticalSlabs.ANDESITE_VERTICAL.get(),
                BOPVerticalSlabs.MUD_BRICK_VERTICAL.get(), ESPVerticalSlabs.POLISHED_ANDESITE_VERTICAL.get(),
        ...
        tag(BlockTags.MINEABLE_WITH_AXE).add(BOPVerticalSlabs.CHERRY_VERTICAL.get(), BOPVerticalSlabs.DEAD_VERTICAL.get(),
                BOPVerticalSlabs.FIR_VERTICAL.get(), BOPVerticalSlabs.HELLBARK_VERTICAL.get(),
                BOPVerticalSlabs.JACARANDA_VERTICAL.get(), BOPVerticalSlabs.MAGIC_VERTICAL.get(),
                BOPVerticalSlabs.MAHOGANY_VERTICAL.get(), BOPVerticalSlabs.PALM_VERTICAL.get(),
                BOPVerticalSlabs.REDWOOD_VERTICAL.get(), BOPVerticalSlabs.UMBRAN_VERTICAL.get(),
                BOPVerticalSlabs.WILLOW_VERTICAL.get(), ESPVerticalSlabs.OAK_VERTICAL.get(),
                ESPVerticalSlabs.BIRCH_VERTICAL.get(), ESPVerticalSlabs.SPRUCE_VERTICAL.get(),
                ESPVerticalSlabs.JUNGLE_VERTICAL.get(), ESPVerticalSlabs.DARK_OAK_VERTICAL.get(),
                ESPVerticalSlabs.ACACIA_VERTICAL.get(), ESPVerticalSlabs.CRIMSON_VERTICAL.get(),
                ESPVerticalSlabs.WARPED_VERTICAL.get(), BOPCorners.CHERRY_CORNER.get(),
                BOPCorners.DEAD_CORNER.get(), BOPCorners.FIR_CORNER.get(),
                BOPCorners.HELLBARK_CORNER.get(), BOPCorners.JACARANDA_CORNER.get(),
                BOPCorners.MAGIC_CORNER.get(), BOPCorners.MAHOGANY_CORNER.get(),
                BOPCorners.PALM_CORNER.get(), BOPCorners.REDWOOD_CORNER.get(),
                BOPCorners.UMBRAN_CORNER.get(), BOPCorners.WILLOW_CORNER.get(),
