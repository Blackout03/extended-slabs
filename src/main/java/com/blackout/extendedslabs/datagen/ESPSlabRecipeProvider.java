...
public class ESPSlabRecipeProvider extends RecipeProvider {
	...
	public void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
		...
		generateSlabRecipes(BOPVerticalSlabs.BLACK_SANDSTONE_VERTICAL.get().asItem(), BOPSlabs.BLACK_SAND_SLAB.get().asItem(), consumer);
		generateSlabRecipes(BOPVerticalSlabs.ORANGE_SANDSTONE_VERTICAL.get().asItem(), BOPSlabs.ORANGE_SAND_SLAB.get().asItem(), consumer);
		generateSlabRecipes(BOPVerticalSlabs.WHITE_SANDSTONE_VERTICAL.get().asItem(), BOPSlabs.WHITE_SAND_SLAB.get().asItem(), consumer);
		...
		ShapedRecipeBuilder.shaped(BOPSlabs.CHERRY_WOOD_SLAB.get(), 6).define('#', BOPBlocks.cherry_wood).pattern("###").unlockedBy("has_cherry_wood", has(BOPBlocks.cherry_wood)).save(consumer);
		ShapedRecipeBuilder.shaped(BOPSlabs.DEAD_WOOD_SLAB.get(), 6).define('#', BOPBlocks.dead_wood).pattern("###").unlockedBy("has_dead_wood", has(BOPBlocks.dead_wood)).save(consumer);
		ShapedRecipeBuilder.shaped(BOPSlabs.FIR_WOOD_SLAB.get(), 6).define('#', BOPBlocks.fir_wood).pattern("###").unlockedBy("has_fir_wood", has(BOPBlocks.fir_wood)).save(consumer);
		ShapedRecipeBuilder.shaped(BOPSlabs.HELLBARK_WOOD_SLAB.get(), 6).define('#', BOPBlocks.hellbark_wood).pattern("###").unlockedBy("has_hellbark_wood", has(BOPBlocks.hellbark_wood)).save(consumer);
		ShapedRecipeBuilder.shaped(BOPSlabs.JACARANDA_WOOD_SLAB.get(), 6).define('#', BOPBlocks.jacaranda_wood).pattern("###").unlockedBy("has_jacaranda_wood", has(BOPBlocks.jacaranda_wood)).save(consumer);
		ShapedRecipeBuilder.shaped(BOPSlabs.MAGIC_WOOD_SLAB.get(), 6).define('#', BOPBlocks.magic_wood).pattern("###").unlockedBy("has_magic_wood", has(BOPBlocks.magic_wood)).save(consumer);
		ShapedRecipeBuilder.shaped(BOPSlabs.MAHOGANY_WOOD_SLAB.get(), 6).define('#', BOPBlocks.mahogany_wood).pattern("###").unlockedBy("has_mahogany_wood", has(BOPBlocks.mahogany_wood)).save(consumer);
		ShapedRecipeBuilder.shaped(BOPSlabs.PALM_WOOD_SLAB.get(), 6).define('#', BOPBlocks.palm_wood).pattern("###").unlockedBy("has_palm_wood", has(BOPBlocks.palm_wood)).save(consumer);
		ShapedRecipeBuilder.shaped(BOPSlabs.REDWOOD_WOOD_SLAB.get(), 6).define('#', BOPBlocks.redwood_wood).pattern("###").unlockedBy("has_redwood_wood", has(BOPBlocks.redwood_wood)).save(consumer);
		ShapedRecipeBuilder.shaped(BOPSlabs.UMBRAN_WOOD_SLAB.get(), 6).define('#', BOPBlocks.umbran_wood).pattern("###").unlockedBy("has_umbran_wood", has(BOPBlocks.umbran_wood)).save(consumer);
		ShapedRecipeBuilder.shaped(BOPSlabs.WILLOW_WOOD_SLAB.get(), 6).define('#', BOPBlocks.willow_wood).pattern("###").unlockedBy("has_willow_wood", has(BOPBlocks.willow_wood)).save(consumer);
		ShapedRecipeBuilder.shaped(BOPSlabs.BLACK_SAND_SLAB.get(), 6).define('#', BOPBlocks.black_sand).pattern("###").unlockedBy("has_black_sand", has(BOPBlocks.black_sand)).save(consumer);
		ShapedRecipeBuilder.shaped(BOPSlabs.ORANGE_SAND_SLAB.get(), 6).define('#', BOPBlocks.orange_sand).pattern("###").unlockedBy("has_orange_sand", has(BOPBlocks.orange_sand)).save(consumer);
		ShapedRecipeBuilder.shaped(BOPSlabs.WHITE_SAND_SLAB.get(), 6).define('#', BOPBlocks.white_sand).pattern("###").unlockedBy("has_white_sand", has(BOPBlocks.white_sand)).save(consumer);
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.END_STONE), ESPSlabs.END_STONE_SLAB.get(), 2).unlocks("has_end_stone", has(Blocks.END_STONE)).save(consumer, "end_stone_slab_from_end_stone_stonecutting");
	}

	public void generateSlabRecipes(Item input, Item output, Consumer<IFinishedRecipe> consumer) {
