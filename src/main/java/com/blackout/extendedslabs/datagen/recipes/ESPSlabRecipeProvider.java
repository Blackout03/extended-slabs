...
public class ESPSlabRecipeProvider extends RecipeProvider {
	...
	public void buildCraftingRecipes(@NotNull Consumer<FinishedRecipe> consumer) {
		...
		ShapedRecipeBuilder.shaped(ESPSlabs.MUD_SLAB.get(), 6).define('#', Blocks.MUD).pattern("###").unlockedBy("has_mud", has(Blocks.MUD)).save(consumer);
		ShapedRecipeBuilder.shaped(ESPSlabs.PACKED_MUD_SLAB.get(), 6).define('#', Blocks.PACKED_MUD).pattern("###").unlockedBy("has_packed_mud", has(Blocks.PACKED_MUD)).save(consumer);
		...
		ShapedRecipeBuilder.shaped(ESPSlabs.TINTED_GLASS_SLAB.get(), 6).define('#', Blocks.TINTED_GLASS).pattern("###").unlockedBy("has_tinted_glass", has(Blocks.TINTED_GLASS)).save(consumer);
		...
		ShapedRecipeBuilder.shaped(ESPSlabs.MANGROVE_WOOD_SLAB.get(), 6).define('#', Blocks.MANGROVE_WOOD).pattern("###").unlockedBy("has_mangrove_wood", has(Blocks.MANGROVE_WOOD)).save(consumer);
		...
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.NETHERRACK), ESPSlabs.NETHERRACK_SLAB.get(), 2).unlockedBy("has_netherrack", has(Blocks.NETHERRACK)).save(consumer,  ExtendedSlabs.MODID + ":netherrack_slab_from_netherrack_stonecutting");
		SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.END_STONE), ESPSlabs.END_STONE_SLAB.get(), 2).unlockedBy("has_end_stone", has(Blocks.NETHERRACK)).save(consumer,  ExtendedSlabs.MODID + ":end_stone_slab_from_end_stone_stonecutting");
	}
