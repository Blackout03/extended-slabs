...
public class MagmaStairBlock extends ESPStairBlock implements IBlockCharacteristics {
	private static final int BUBBLE_COLUMN_CHECK_DELAY = 20;
	private final List<TagKey<Block>> characteristics;
	public Block material;
	public Supplier<Block> materialCorner;

	public MagmaStairBlock(List<TagKey<Block>> characteristics, Block material, Supplier<Block> materialCorner) {
	...
	public MagmaStairBlock(Block material, Supplier<Block> materialCorner) {
