...
public class MagmaVerticalSlabBlock extends ESPVerticalSlabBlock implements IBlockCharacteristics {
	...
	public MagmaVerticalSlabBlock(List<TagKey<Block>> characteristics, Block material, Supplier<Block> materialSlab) {
	...
	public MagmaVerticalSlabBlock(Block material, Supplier<Block> materialSlab) {
