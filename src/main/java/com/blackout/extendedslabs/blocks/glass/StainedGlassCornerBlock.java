...
public class StainedGlassCornerBlock extends GlassCornerBlock implements BeaconBeamBlock, IBlockCharacteristics {
	...
	public StainedGlassCornerBlock(List<TagKey<Block>> characteristics, Block material, Block materialSlab, DyeColor color, Properties builder) {
	...
	public StainedGlassCornerBlock(Block material, Block materialSlab, DyeColor color, Properties builder) {
